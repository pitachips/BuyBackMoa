...
if PROJECT_ENV == 'prod':
    ...
    DEBUG = False
    ALLOWED_HOSTS.append(secret['HOST']) if 'HOST' in secret else ALLOWED_HOSTS   # secret.json 세팅 필요
    SECRET_KEY = secret['SECRET_KEY'] if 'SECRET_KEY' in secret else SECRET_KEY  # use secret key in the secret.json
    DATABASES = {}
