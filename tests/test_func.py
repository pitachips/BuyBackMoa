...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def send_searchword_to_searchbox(self, searchword, timeout=10, clearup=True):
    ...
    def test_basic_search(self):
        self.browser.get(self.live_server_url)
        # 검색창에 '특허법' 을 입력하고 전송한다.
        self.send_searchword_to_searchbox('특허법')
        ...
        # 이제 'introduction to algorithms'을 판매하려고 한다. 우선 검색창을 깨끗이 하고 검색한다.
        self.send_searchword_to_searchbox('introduction to algorithms')
    ...
    def test_identical_item_is_served_from_memcached_to_different_browsers(self):
        # 크롬에서 '고성능 파이썬'을 검색한다.
        self.browser.get(self.live_server_url)
        self.send_searchword_to_searchbox('고성능 파이썬')
        # 크롬 종료
        self.browser.quit()
    ...
    def test_empty_searchword_cannot_be_submitted(self):
        ...
        self.send_searchword_to_searchbox('')
